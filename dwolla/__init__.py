...
class DwollaClientApp(object):
    ...
    def get_oauth_token(self, code, **kwargs):
        '''
        Returns an array with valid OAuth and refresh tokens with the code
        given to you by Dwolla when they redirected the user back to your
        site after you sent them to the url generated by :method:`init_oauth_url`.
    ...
    def refresh_auth(self, refresh_token, **kwargs):
        '''
        Returns an array with valid OAuth and refresh tokens with the code
        given to you by Dwolla when they redirected the user back to your
        site after you sent them to the url generated by :method:`init_oauth_url`.

        :param refresh_token: Verification code obtained from Dwolla in response
        to initial `get_oauth_token` request.
